$(document).ready(function () {
	...
	// remove an additional charge from the list
...
//select the appropiate route upon checking in a reservation
function submitForm () {
	// redirects to the appropriate route when checking in a reservation
